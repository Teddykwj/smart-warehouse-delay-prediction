...
> CV 베스트: **v16** — Blend CV MAE `8.9426`
>
> Dacon 베스트: **v16** — Dacon Public `10.4899` (CV MAE `8.9426`)
>
> CV-Dacon Gap 추이: 초기 ~1.59 → v15 ~1.60 → v16 **1.547** (gap 축소)
...
| 16 | 2026-04-25 | **v16** ★ | **8.947343** | **8.953853** | **8.942603** | **0.60** | **10.489869** | **1.547266** | 시나리오 컨텍스트 피처(25개), 레이아웃 클러스터링 K-means(15) + cluster TE, availability_ratio 다항식, 192→198 features, Optuna 60trials — **CV 베스트 & Dacon 베스트** |
...
- **고오차 레이아웃**: WH_051(34.6), WH_073(33.9), WH_217(33.5), WH_049(32.8), WH_098(30.1) — v16에서 소폭 개선됐으나 여전히 고오차 (v15 대비 WH_051: 35.1→34.6, WH_073: 34.4→33.9)
